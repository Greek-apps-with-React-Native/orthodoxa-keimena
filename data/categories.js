...
export const CATEGORIES = [
	...
	new Category('category_7', 'Λειτουργικά', '#FFFFF0'), // lightseagreen
	new Category('category_8', 'Ιεροί Κανόνες', '#E0FFFF'), // ivory
	new Category('category_9', 'Θρησκειολογικά', '#D3D3D3'), // lightgray
	new Category('category_10', 'Ξενόγλωσσα', '#ADD8E6'), // lightblue
	new Category('category_11', 'Περιοδικά', '#FFFAFA'), // snow
